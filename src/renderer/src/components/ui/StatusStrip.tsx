...
function StatusStrip({ progress, className, children }: StatusStripProps): React.JSX.Element {
  return (
    <div className={cx('relative border-border border-t bg-card px-6 py-1.5', className)}>
      {progress !== undefined && (
        <div
